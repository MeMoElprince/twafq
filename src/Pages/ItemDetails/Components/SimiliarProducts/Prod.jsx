    ...
    rounded-2xl overflow-hidden font-medium'>
      ...
      <div
        ...
        <div className='m-4 flex justify-between'>
          <div className='px-2 flex items-center w-fit bg-Black bg-opacity-20 backdrop-filter backdrop-blur-2 rounded-lg text-[2.5vh]'>
            <p>{Amount}</p>
        ...
        }} className='relative p-4 rounded-lg text-Black space-y-5 group-hover:top-0 duration-300'>
          <div style={{
