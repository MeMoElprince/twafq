    ...
    <div className="bg-white p-6 select-none relative pt-[82px] border border-Black/20 w-[290px] rounded-2xl myFont overflow-hidden mx-auto mt-4">
      ...
      <div className="w-full bg-Black/20 h-[50px] absolute top-0 left-0 flex gap-4">
        {
          ...
          (
            <>
              ...
              <div className="h-full bg-gradient-to-r from-red-500 to-yellow-400 absolute z-10" style={{ width: `${userDetails?.compatibilityRatio}%` }}></div>
            </>
          )
          :
          (
...

      {
        ...
        <div className="relative group">
          ...
          <span className="absolute bg-gray-300 text-Black text-sm font-medium p-1 px-2 mt-[10%] rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300">
