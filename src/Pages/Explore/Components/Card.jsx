    ...
    <div className="bg-white p-6 select-none relative pt-[82px] h-[470px] border border-Black/20 max-w-[400px] w-[100%] md:w-[50%] md4:w-[35%] lg:w-[30%] rounded-2xl myFont overflow-hidden mt-4">
          ...
          <>
            <div className={`center w-full gap-2 z-20`}>
              <p className="text-lg font-medium text-Black">
                {i18n.language === "ar" ? "نسبة التوافق:" : "Compatibility:"}
              </p>
              <p className="text-lg font-medium text-Black">
      ...
      {userDetails && userDetails.isVerifiedUser && (
        <div className="relative group">
          ...
          <span
            className={`absolute bg-gray-300 text-Black pointer-events-none text-sm font-medium p-1 px-2 mt-[34px] ${
      ...
      <div className="absolute group w-full">
        ...
        <span
          className={`absolute bg-gray-300 text-Black pointer-events-none text-sm font-medium p-1 px-2 top-[152px] ${
      ...
      <Link
        to={`/userprofile/${userDetailsReceived.id}`}
      ...
      >
          ...
          <img
            src={
              userDetails?.isVerifiedUser
                ? userDetails && userDetails.gender[1] === "Male"
                  ? verifiedMan
                  : verifiedWoman
                : userDetails && userDetails.gender[1] === "Male"
                ? Man
        ...
        <div className="mt-4 text-center center flex-col gap-2">
          ...
          >
            <p
              className={`text-lg text-Black font-bold line-clamp-1 max-w-[90%]`}
              style={{
                direction: `${
                  (isRTL && english.test(userDetails?.firstName)) ||
                  (!isRTL && !english.test(userDetails?.firstName))
            ...
            <p className="text-md text-Black font-medium">
              {"(" + userDetails?.age + " " + (isRTL ? "سنة" : "Years") + ")"}
            </p>
          </div>
