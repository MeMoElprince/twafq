...
export default function CustomerForm({ handleChange, handleSubmit, formData, errorMessage, loading }) {
  return (
    <form onSubmit={handleSubmit} className='Form center flex-col gap-10 w-[70%]'>
      ...
      <button type='submit' className={`${Styles.loginBtnAnimate} bg-Black Fredoka text-White text-[22px] w-[100%] py-[14px] rounded-[20px]
                            ...
                            hover:before:left-0 
                            ${loading ? 'cursor-wait  before:left-[0] w-[105%] my-[0px] py-[13px]' : 'cursor-pointer before:left-[-100%] w-[100%] my-0 py-[14px]'}
                        `}>Sign Up</button>
