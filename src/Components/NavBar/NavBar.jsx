    ...
    <div className="w-full sm:px-6 lg:px-8 flex items-center justify-between h-20 center">
            <div className="center w-[90%]">
              ...
              <div className={`hidden md4:flex items-baseline gap-8 lg2:gap-12 ${isRTL ? "mr-auto" : "ml-auto"}`}>
                ...
                <Link to="/login" className={`hidden md4:block ${isRTL ? "mr-auto" : "ml-auto"} focus:outline-none`}><button className="bg-red-500 hover:text-Black focus:outline-none transition-colors duration-150 text-White px-6 py-2 rounded-full text-lg font-medium">{t("navbar.login")}</button></Link>
            </div>
